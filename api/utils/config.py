...
def validate_config() -> WineBotConfig:
    ...
    try:
        ...
        data = {
            ...
            "WINEBOT_MAX_OPERATION_RECORDS": _get_int("WINEBOT_MAX_OPERATION_RECORDS", 500),
            "WINEBOT_OPERATION_RECORD_TTL_SECONDS": _get_int("WINEBOT_OPERATION_RECORD_TTL_SECONDS", 86400),
            ...
            "WINEBOT_TIMEOUT_AUTOMATION_APP_RUN_SECONDS": _get_int("WINEBOT_TIMEOUT_AUTOMATION_APP_RUN_SECONDS", 30),
            "WINEBOT_TIMEOUT_AUTOMATION_SCRIPT_SECONDS": _get_int("WINEBOT_TIMEOUT_AUTOMATION_SCRIPT_SECONDS", 30),
            "WINEBOT_TIMEOUT_RECORDING_CONTROL_SECONDS": _get_int("WINEBOT_TIMEOUT_RECORDING_CONTROL_SECONDS", 15),
            "WINEBOT_TIMEOUT_RECORDING_STOP_SECONDS": _get_int("WINEBOT_TIMEOUT_RECORDING_STOP_SECONDS", 20),
            "WINEBOT_TIMEOUT_LIFECYCLE_WINEBOOT_SECONDS": _get_int("WINEBOT_TIMEOUT_LIFECYCLE_WINEBOOT_SECONDS", 10),
            "WINEBOT_TIMEOUT_LIFECYCLE_WINESERVER_SECONDS": _get_int("WINEBOT_TIMEOUT_LIFECYCLE_WINESERVER_SECONDS", 5),
            "WINEBOT_TIMEOUT_LIFECYCLE_COMPONENT_SECONDS": _get_int("WINEBOT_TIMEOUT_LIFECYCLE_COMPONENT_SECONDS", 3),
            "WINEBOT_TIMEOUT_LIFECYCLE_SESSION_HANDOVER_SECONDS": _get_int("WINEBOT_TIMEOUT_LIFECYCLE_SESSION_HANDOVER_SECONDS", 60),
            "WINEBOT_RECORDER_HEARTBEAT_STALE_SECONDS": _get_int("WINEBOT_RECORDER_HEARTBEAT_STALE_SECONDS", 30),
            "WINEBOT_RECORDER_HEARTBEAT_GRACE_SECONDS": _get_int("WINEBOT_RECORDER_HEARTBEAT_GRACE_SECONDS", 15),
