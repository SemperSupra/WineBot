...
# 4. Output is auto-copied to demo/output/ as <script-name>.mkv/.gif/.vtt
# Or manually:
docker cp winebot-interactive:/tmp/trimmed.mkv demo/output/<name>.mkv
docker cp winebot-interactive:/tmp/trimmed.gif demo/output/<name>.gif
```
...
└── output/                             # Auto-generated by stop_recording()
    ├── .gitignore
    ├── input-pipeline-demo.mkv / .gif / .vtt
    ├── demo-ci-pipeline.mkv / .gif / .vtt
    ├── demo-cv-control.mkv / .gif / .vtt
    ├── demo-7zip.mkv / .gif / .vtt
    ├── demo-winebox.mkv / .gif / .vtt
    ├── demo-installer-qa.mkv / .gif / .vtt
    ├── hook-demo.mkv / .gif / .vtt
    ├── demo-notepadpp.mkv / .gif / .vtt
    ├── demo-vlc.mkv / .gif / .vtt
    ├── demo-supertux.mkv / .gif / .vtt
    └── ...
```
