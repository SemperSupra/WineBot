...
| Standards conformance | OpenAPI/HTTP/OCI/CLI/mDNS contract enforcement | `tests/test_conformance_runtime_policy.py` (WineBot-specific), `tests/conformance/` in [winebot-contracts](https://github.com/mark-e-deyoung/winebot-contracts) (shared) |
